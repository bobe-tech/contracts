...
/// @custom:oz-upgrades-from SwapContract
contract SwapContractV2 is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    using Math for uint256;
    using SafeERC20 for IERC20;

    // Storage layout MUST match SwapContract V1 exactly (same order, same types).
